package yuncar.aten.com.mymode.calendarView.bean;
...
public class AttrsBean {
    ...
    private boolean switchChoose = true;//单选时切换月份，是否选中上次的日 期
    ...
    private int dayBg = R.drawable.bg_dot_yellow_calendar;//选中的背景
